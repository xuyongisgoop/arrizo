...
<![endif]-->
	<ul class="am-avg-sm-1 am-thumbnails">
		<c:forEach items="${result.data.product_list}" var="product">
			<li>
				<a href="#">
					<div style="background-image:url(${product.pic});background-repeat:no-repeat;background-size:100% 100%;height:300px;">
						<div class="am-g" style="position:relative;top:275px;width:100%;color:white;background:rgba(13, 13, 13, 0.5)">
							<div class="am-u-sm-6">产品名称：${product.product_name}</div>
							<div class="am-u-sm-6">产品价格：${product.price}</div>
						</div>
						<!-- <div class="am-g" style="position:absolute;bottom:0px;width:100%;">
							<div class="am-u-sm-12">备注：${product.product_desc}</div>
						</div> -->
					</div>
				</a>
			</li>
