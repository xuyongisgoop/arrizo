...
<div class="am-g">
	<div class="am-u-sm-10 am-u-sm-centered">
		<form id="page_form" class="am-form"
			action="${ctx}/user/registerSubmit.html" method="post">

			<fieldset>
				<div class="am-form-group">
					<label for="doc-ds-ipt-1">常用手机号</label> <input type="text"
						name="phone" id="doc-ds-ipt-1" class="am-form-field"
						placeholder="输入手机号">
				</div>
				<div class="am-form-group">
					<label for="doc-ds-ipt-2">密 码</label> <input type="password"
						name="password" id="doc-ds-ipt-1" class="am-form-field"
						placeholder="请设置一个密码">
				</div>
				<div class="am-form-group">
					<label for="doc-ds-ipt-3">确认密码</label> <input type="password"
						name="re_password" id="doc-ds-ipt-2" class="am-form-field"
						placeholder="请再次输入密码">
				</div>
				<input type="hidden" name="store_id" value="${store_id}">
				<button type="submit" class="am-btn base-ok-color">提 交</button>
				<br> <br> <br>
			</fieldset>
			<br>
		</form>
